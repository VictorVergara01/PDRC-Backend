...
# Security settings
SECRET_KEY = config('SECRET_KEY', 'default-key')  # Usar una clave secreta segura en producción
DEBUG = config('DEBUG', 'False') == 'True'  # Controlar DEBUG desde las variables de entorno
ALLOWED_HOSTS = config('ALLOWED_HOSTS', '*').split(',')  # Permitir hosts dinámicamente
...
DATABASES = {
    'default': {
        ...
        'NAME': config('MYSQLDATABASE', default='nombre_base_datos'),
        'USER': config('MYSQLUSER', default='usuario'),
        'PASSWORD': config('MYSQLPASSWORD', default='contraseña'),
